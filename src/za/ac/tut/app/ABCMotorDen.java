...
public class ABCMotorDen {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int mainMenuOption = getMainMenuOption(new Scanner(System.in));

            while (mainMenuOption != 4) {
                switch (mainMenuOption) {
                    case 1:
                        int carsMenuOption;
                        boolean carsMenuOptionIsValid;

                        do {
                            carsMenuOption = displayCarsProcessingMenu(new Scanner(System.in));
                            carsMenuOptionIsValid = validateCarsMenuOption(carsMenuOption);
                            
                            if (! carsMenuOptionIsValid){
                                System.out.println("The option " + carsMenuOption + " is not available for this menu. YTry again.\n");
                            }
                        } while (! carsMenuOptionIsValid);
                    ...
                    case 3:
                        break;
                    default:
                        System.out.println("The option " + mainMenuOption + " is not part of the given options. Try again.\n");
                }

                mainMenuOption = getMainMenuOption(new Scanner(System.in));
            }
    ...
    private static boolean validateCarsMenuOption(int carsMenuOption) {
        switch (carsMenuOption) {
            case 1:
            case 2:
            case 3:
            case 4:
